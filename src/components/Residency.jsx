		...
		<>
			...
			<nav className="about-container">
				<nav className="about-container-text">
					...
					<h2>residents</h2>
					<p>Fever Dream is proud to present [name] as its current resident.</p>
					<p>Click here to see our archive of past residents. </p>
					<h2>frequently asked questions</h2>
					<p>Why is the program called Fever Dream?</p>
